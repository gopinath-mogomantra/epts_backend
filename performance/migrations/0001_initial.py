    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rank', models.PositiveSmallIntegerField(blank=True, help_text='Rank position based on total score.', null=True)),
                ...
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='performance_evaluations', to='employee.employee')),
            ],
            options={
