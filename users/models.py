...
class UserManager(BaseUserManager):
    """Custom manager for User model with auto emp_id generation and secure password handling."""
    ...
    def create_user(self, username=None, password=None, **extra_fields):
        """Create and save a regular user with autogenerated emp_id and secure password."""
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    # Department Link (Avoid circular import using string reference)
    ...
    def unlock_account(self):
        """Unlock manually or automatically after lock period."""
    ...
    def increment_failed_attempts(self):
        ...
        if self.account_locked and self.locked_at:
            # Auto unlock if 2-hour lock expired
